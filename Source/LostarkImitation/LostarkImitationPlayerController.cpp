...
void ALostarkImitationPlayerController::SetupInputComponent()
{
	...
	if (IsLocalPlayerController())
	{
		...
		if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(InputComponent))
		{
			...
			EnhancedInputComponent->BindAction(SetDestinationClickAction, ETriggerEvent::Started, this, &ALostarkImitationPlayerController::OnInputStarted);
			EnhancedInputComponent->BindAction(SetDestinationClickAction, ETriggerEvent::Triggered, this, &ALostarkImitationPlayerController::OnSetDestinationTriggered);
			EnhancedInputComponent->BindAction(SetDestinationClickAction, ETriggerEvent::Completed, this, &ALostarkImitationPlayerController::OnSetDestinationReleased);
...
void ALostarkImitationPlayerController::OnInputStarted()
{
	StopMovement();
}

void ALostarkImitationPlayerController::OnSetDestinationTriggered()
{
...
void ALostarkImitationPlayerController::OnSetDestinationReleased()
{
...
void ALostarkImitationPlayerController::OnTouchTriggered()
{
	bIsTouch = true;
	OnSetDestinationTriggered();
}

void ALostarkImitationPlayerController::OnTouchReleased()
{
	bIsTouch = false;
